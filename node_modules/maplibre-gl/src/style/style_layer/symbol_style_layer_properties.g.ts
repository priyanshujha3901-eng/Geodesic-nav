...
const getLayout = (): Properties<SymbolLayoutProps> => layout = layout || new Properties({
    ...
    "symbol-height-offset": new DataDrivenProperty(styleSpec["layout_symbol"]["symbol-height-offset"] as any as StylePropertySpecification, "symbol-height-offset"),
    "symbol-height-anchor": new DataConstantProperty(styleSpec["layout_symbol"]["symbol-height-anchor"] as any as StylePropertySpecification, "symbol-height-anchor"),
});
